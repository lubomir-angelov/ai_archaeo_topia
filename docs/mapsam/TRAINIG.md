...
Train prompt encoder and/or mask decoder
Use bbox or center point prompts
Compute loss between predicted mask and mound target mask
Ignore uncertain_ignore pixels in the loss
